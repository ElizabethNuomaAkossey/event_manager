...
def show_footer():
    ...
    with ui.element("footer").style("background-color: navy;").classes("w-full"):
        ...
        ui.element("div").classes("bg-white items-center justify-center w-[89%] min-h-[0.2px] ")

        with ui.element("div").classes("justify-between items-center justify-center px-20 text-white py-5"):
            ...
            with ui.element("div").classes("w-[30%] h-[30%] text-white flex "):
